...
import {SBT_SS2ERC721Base, ERC721, ERC721TokenReceiver} from "./common/SBT_SS2ERC721Base.sol";

/// @notice SSTORE2-backed version of Solmate's ERC721, with support for multiple batches

abstract contract MultiSS2ERC721 is SBT_SS2ERC721Base {
    ...
    function _loadCurrentState()
        internal
        view
        returns (uint256 numPointers, address lastPointer, uint256 lastPointerLength)
    {
